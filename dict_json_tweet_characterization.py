...
# Create a csv file to be read codigo e nome
# File need to be a parameter
...
# Create a dictonary 
contagem_tweets = {171502474: 0,881194452: 0,629596700: 0,96828209: 0,96129950: 0,123154339: 0,39251495: 0,69037483: 0,38413341: 0,59857882: 0,15493428 : 0}

# contagem_tweets = {}
# if tweet.id in array:
#     if contagem_tweets.has_key(tweet.id):
#         contagem_tweets[tweet.id] += 1
#     else:
#         contagem_tweets[tweet.id] = 1

# for id in contagem_tweets:
#     print id, contagem_tweets[]
...
''' Teste function'''
def operations_dict(database, output_information, city_name):
    ...
    for line in tweets_file:
        try:
            ...
            # Tweet ID
                ...
                if user_id_comp in eval(users_ids):
                  	if contagem_tweets.has_key(user_id_comp):
                   		contagem_tweets[user_id_comp] +=1
                   		# temp = temp + 1
                   	else:
                   		contagem_tweets[user_id_comp] = 1
                    # if tweet.id in array:
...
# python automatic_tweets.py -i /scratch/gavelar/dump_UTFPR/dump_UTFPR_geo/ctba/sfields/sfield_traffic_geo_marco_curitiba.json -o output -c ctba
if ( __name__ == "__main__" ):
    ...
    # tweets of the users
    operations_dict(database,output_information, city_name)
    stoptime = time.time()
