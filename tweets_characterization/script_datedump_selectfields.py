...
def get_parameters():
    ...
    parser.add_argument('-sd','--startDate', help='The date when a project or task is scheduled to begin/start', required=True)
    parser.add_argument('-ed','--endDate', help='The date when a project or task is scheduled to finish/end', required=True)
